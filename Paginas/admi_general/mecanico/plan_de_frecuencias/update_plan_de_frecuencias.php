...
$sql="UPDATE plan_de_frecuencias SET nombre_paso_nivel='$paso_nivel',frecuencia_asc='$frecuencia_asc',frecuencia_desc='$frecuencia_desc',señal_asc='$señal_asc',señal_desc='$señal_desc',tension_asc='$tension_asc',tension_desc='$tension_desc',filtro='$filtro',ubicacion='$ubicacion' WHERE id_plan_de_frecuencia='$id'";
